    ...
    <form method="post" action="inquiry_insert.php">
        <ul>
            ...
            <li>
                ...
                <input type="tel" id="phone1" name="phone1" maxlength="3" size="3" required>-<input type="tel" id="phone2" name="phone2" maxlength="4" size="4" required>-<input type="tel" id="phone3" name="phone3" size="4" maxlength="4" required>
            </li>
            <li>
